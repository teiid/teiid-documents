...
See link:../reference/as_virtual-databases.adoc[VDB Guide] and link:../reference/r_metadata-repositories.adoc[Metadata Repositories] for more on a typical vdb file and zip structures. 
