...
* https://issues.redhat.com/browse/TEIID-5874[TEIID-5874] added support for transactional Infinispan/JDG access.  Support for cache aliasing was removed.
* https://issues.redhat.com/browse/TEIID-5896[TEIID-5896] added support for EXTRACT QUARTER and EPOCH.
* https://issues.redhat.com/browse/TEIID-5798[TEIID-5798] added the POLICY construct to replace specifying a CONDITION on a permission.
