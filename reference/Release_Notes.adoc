...
* https://issues.redhat.com/browse/TEIID-5861[TEIID-5861] Added multiple join support to the salesforce translator which can be enabled with the maxFromGroups translator property.
