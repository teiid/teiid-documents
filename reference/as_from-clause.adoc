...
* FROM TABLE(subquery) [AS] alias. For more information, see {% if book.targetDVProd %}xref:nested-tables{% else %}link:r_nested-tables.adoc{% endif %}[Nested tables]
...
For more information, see _Optional join_ in {% if book.targetDVProd %}xref:federated-optimizations{% else %}link:r_federated-optimizations.adoc{% endif %}[Federated optimizations].

* FROM TEXTTABLE… For more information, see {% if book.targetDVProd %}xref:texttable{% else %}link:r_texttable.adoc{% endif %}[TEXTTABLE].

* FROM XMLTABLE… For more information, see {% if book.targetDVProd %}xref:xmltable{% else %}link:r_xmltable.adoc{% endif %}[XMLTABLE].

* FROM ARRAYTABLE… For more information, see {% if book.targetDVProd %}xref:arraytable{% else %}link:r_arraytable.adoc{% endif %}[ARRAYTABLE].

* FROM OBJECTTABLE… For more information, see {% if book.targetDVProd %}xref:objecttable{% else %}link:r_objecttable.adoc{% endif %}[OBJECTTABLE].

* FROM JSONTABLE… For more information, see {% if book.targetDVProd %}xref:jsontable{% else %}link:r_jsontable.adoc{% endif %}[JSONTABLE].

* FROM SELECT… For more information, see _Inline views_ in {% if book.targetDVProd %}xref:subqueries{% else %}link:r_subqueries.adoc{% endif %}[Subqueries].
