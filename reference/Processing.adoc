...
Joins involving equi-join predicates are also eligible to be made into link:Federated_Optimizations.adoc#18646293_FederatedOptimizations-DependentJoins[dependent joins].
