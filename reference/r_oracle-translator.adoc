...
NOTE: The Oracle provide JDBC driver may cause memory issues due to excessive buffer usage.  Please see link:https://issues.redhat.com/browse/TEIID-4815[a related issue] and link:http://www.oracle.com/technetwork/topics/memory.pdf[an Oracle whitepaper].
