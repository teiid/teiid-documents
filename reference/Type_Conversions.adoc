...
[a] string to xml is equivalent to XMLPARSE(DOCUMENT exp) - See also link:XML_Functions.adoc#_xmlparse[XML Functions#XMLPARSE]
[b] xml to string is equivalent to XMLSERIALIZE(exp AS STRING) - see also link:XML_Functions.adoc#_xmlserialize[XML Functions#XMLSERIALIZE]
