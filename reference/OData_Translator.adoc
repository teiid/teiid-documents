...
TIP: *Want to use as Server?* - Teiid can not only consume OData based data sources, but it can expose any data source as an Odata based webservice. For more information see https://docs.jboss.org/author/display/TEIID/OData+Support[OData Support].
