...
|<<importDatabase,Import VDB>>, <<importSchema,Import foreign schema>>
...
|[[token_SESSION_USER]]_SESSION_USER_
|<<function,function>>
...
|[[token_WITH]]_WITH_
|<<assignStatement,assignment statement>>, <<createRole,create role >>, <<importDatabase,Import VDB>>, <<queryExpression,query expression>>, <<sqlStatement,data statement>>
...
|<<basicNonReserved,basicNonReserved>>, <<importDatabase,Import VDB>>
...
|<<alterDatabase,ALTER DATABASE >>, <<basicNonReserved,basicNonReserved>>, <<createDatabase,create database>>, <<importDatabase,Import VDB>>, <<useDatabase,use database>>
...
|<<basicNonReserved,basicNonReserved>>, <<createDatabase,create database>>, <<createServer,create server>>, <<importDatabase,Import VDB>>, <<useDatabase,use database>>, <<xmlSerialize,xml serialize>>
...
|<<createPolicy,CREATE POLICY>>, <<filterClause,filter clause>>, <<grant,GRANT>>, <<notCrit,boolean factor>>
...
|[[usage_importDatabase]]_<<importDatabase, Import VDB>>_
|<<ddlStmt,ddl statement>>
...
* ( <<token_EXTRACT,EXTRACT>> <<<token_LPAREN,lparen>>> ( <<token_YEAR,YEAR>> | <<token_MONTH,MONTH>> | <<token_DAY,DAY>> | <<token_HOUR,HOUR>> | <<token_MINUTE,MINUTE>> | <<token_SECOND,SECOND>> | <<token_QUARTER,QUARTER>> | <<token_EPOCH,EPOCH>> | <<token_DOW,DOW>> | <<token_DOY,DOY>> ) <<token_FROM,FROM>> <<<expression,expression>>> <<<token_RPAREN,rparen>>> )
...
* <<token_SESSION_USER,SESSION_USER>>
...
=== [[importDatabase]]_<<usage_importDatabase, Import VDB>>_ ::= 
