...
|<<explainOption,explain option>>, <<nonReserved,non-reserved identifier>>
...
|<<explainCommand,explain>>, <<nonReserved,non-reserved identifier>>
...
|<<createSchema,create schema>>, <<dropSchema,drop schema>>, <<grantOption,Create GRANT>>, <<importSchema,Import foreign schema>>, <<nonReserved,non-reserved identifier>>, <<revokeGrantOption,Revoke GRANT>>, <<useSchema,set schema>>
