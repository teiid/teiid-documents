...
For details about the exact form of SQL that {{ book.productnameFull }} accepts, see the xref:bnf-for-sql-grammar[BNF for SQL grammar].
...
include::r_explain-statements.adoc[leveloffset=+1]
{% endif %}
