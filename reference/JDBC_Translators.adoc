...
The resource adapter for this translator provided through data source in WildFly, See to Admin Guide section link:../client-dev/WildFly_DataSource.adoc[WildFly Data Sources] for configuration.
