...
The resource adapter for this translator provided through data source in JBoss AS, See to Admin Guide section link:../admin/JDBC_Data_Sources.adoc[JDBC Data Sources] for configuration.
