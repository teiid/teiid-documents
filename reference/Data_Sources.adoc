...
=== link:JDBC_Translators.adoc[Databases]
...
=== link:Web_Services_Translator.adoc[Web Services]

* SOAP
* REST
* Arbitrary HTTP(S)

=== link:OData_Translator.adoc[OData]
...
=== link:LDAP_Translator.adoc[LDAP]

* RedHat Directory Server
* Active Directory

=== link:File_Translator.adoc[Files]
