...
TIP: For information about setting properties, see _Override execution property_ in {% if book.targetDVProd %}xref:translators{% else %}link:as_translators.adoc{% endif %}[Translators], and review the examples in the 
