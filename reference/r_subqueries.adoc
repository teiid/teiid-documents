...
Subqueries are supported in quantified criteria, the EXISTS predicate, the IN predicate, and as link:Expressions.adoc#_scalar_subqueries[Scalar Subqueries].
