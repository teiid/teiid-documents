...
*SET SHOWPLAN [ON|DEBUG]*- Returns the processing plan or the plan and the full planner link:Query_Planner.adoc[Debug Log]. See also the link:../client-dev/SET_Statement.adoc[SET Statement].
