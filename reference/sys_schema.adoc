...
If client logic expects actual values, such as integration with link:../client_dev/GeoServer_Integration.adoc[GeoServer], then you may need to set these values manually. 
