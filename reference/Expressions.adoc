...
* link:Expressions.adoc#18646218_Expressions-ColumnIdentifiers[Column Identifiers]
* link:Expressions.adoc#18646218_Expressions-Literals[Literals]
* link:Scalar_Functions.adoc[Scalar Functions]
* link:Expressions.adoc#18646218_Expressions-AggregateFunctions[Aggregate Functions]
* link:Expressions.adoc#18646218_Expressions-WindowFunctions[Window Functions]
* link:Expressions.adoc#18646218_Expressions-CaseandSearchedCase[Case and Searched Case]
* link:Expressions.adoc#18646218_Expressions-ScalarSubqueries[Scalar Subqueries]
* link:Expressions.adoc#18646218_Expressions-ParameterReferences[Parameter References]
* link:Criteria.adoc[Criteria]
* link:Expressions.adoc#18646218_Expressions-Arrays[Arrays]
...
aggregate can be any link:Expressions.adoc#18646218_Expressions-AggregateFunctions[Aggregate Functions]. Ranking can be one of ROW_NUMBER(), RANK(), DENSE_RANK().
