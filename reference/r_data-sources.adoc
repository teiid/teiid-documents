...
See the link:OpenAPI_Translator.adoc[OpenAPI] and link:Swagger_Translator.adoc[Swagger] Translators
...
See the link:File_Translator.adoc[File Translator] and file sources (file, hdfs, s3, and ftp) for use with:
