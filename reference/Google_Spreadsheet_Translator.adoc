...
WARNING: Non-string fields are updated using the canonical Teiid SQL value - in cases where the spreadsheet is using a non-conforming locale, consider disallowing updates.  See also link:https://issues.jboss.org/browse/TEIID-4854[TEIID-4854]
