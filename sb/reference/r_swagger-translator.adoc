...
Starting January 1st 2016 the Swagger Specification has been donated to the Open API Initiative (OAI) and has been renamed to the OpenAPI Specification.   The swagger translator provides support for Swagger version 1/2 and OpenAPI version 2. See also the link:OpenAPI_Translator.adoc[OpenAPI Translator].
