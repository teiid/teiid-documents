...
NOTE: Anonymous SSL mode is not supported for some JREs, see the link:link:../security/Teiid_Server_Transport_Security.adoc[Teiid Server Transport Security] for alternatives.
