...
An https://issues.jboss.org/browse/TEIID-5555[experimental feature] is available to automatically provide an https://www.openapis.org/[OpenAPI] / Swagger 2.0 metadata via base-url/vdb/schema/swagger.json 
