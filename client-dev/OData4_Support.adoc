...
 
|proxy-base-uri
|Defines the proxy server’s URI to be used in OData responses.  Only needs to be set if your proxy does not support the Forwarded nor the X-Forwarded headers.
|n/a
