...
* *Load Balancing*: Take look at the https://docs.jboss.org/author/display/TEIID/Client+Developer%27s+Guide[Client Developer’s Guide] on how to use load balancing between multiple nodes.
* *Fail Over*: Take look at the https://docs.jboss.org/author/display/TEIID/Client+Developer%27s+Guide[Client Developer’s Guide] on how to use fail over between multiple nodes.
