...
System properties can also be set for client VMs. See https://docs.jboss.org/author/display/TEIID/Additional+Socket+Client+Settings[Additional Socket Client Settings].
