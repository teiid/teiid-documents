...
* _org.teiid.backslashDefaultMatchEscape_ - defaults to false. Set to true to use '\' as the default escape character for LIKE predicates when no escape is specified. 
