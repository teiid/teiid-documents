...
2.  Decide whether to use the {{ book.productnameFull }} archetype template to create your initial custom translator project and classes or manually create your environment. Refer to link:Environment_Setup.adoc[Environment Setup].
3.  Implement the required classes defined by the Translator API. Refer to link:Implementing_the_Framework.adoc[Implementing the Framework]. +
