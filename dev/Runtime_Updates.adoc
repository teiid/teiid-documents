...
The use of the other `EventDistributor` methods to manually distribute other events is not always necessary. Check the link:../reference/System_Schema.adoc[System Procedures] for SQL based updates.
