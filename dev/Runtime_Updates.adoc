...
The use of the other `EventDistributor` methods to manually distribute other events is not always necessary. Check the https://docs.jboss.org/author/display/TEIID/System+Procedures[System Procedures] for SQL based updates.
