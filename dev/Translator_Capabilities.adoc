...
This documentation for system functions can be found at https://docs.jboss.org/author/display/TEIID/Scalar+Functions[Scalar Functions]. If the Translator states that it supports a function, it must support all type combinations and overloaded forms of that function.
