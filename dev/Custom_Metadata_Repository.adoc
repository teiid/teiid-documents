...
Once the JAR file has been built, it needs to be deployed in the WildFly as a module under _<jboss-as>/modules_ directory. Follow the below steps to create a module.
